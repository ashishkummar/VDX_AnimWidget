...
const initialState = {
	...
	items:[],
	itemSelectedIndex:-1,
	components:[{key:'map',	val:'map', selected:false, code:''}, 
				{key:'hybrid', val:'hybrid gallery', selected:false, code:''}, 
				{key:'scrollbar', val:'scrollbar', selected:false,   code:''},
				{key:'containerGallery', val:'container gallery', selected:false,code:''}, 
				{key:'tabs', val:'tabs', selected:false,code:''}, 
				{key:'threeSixty', val:'three sixty', selected:false,code:''}, 
				{key:'imageGallery', val:'image gallery', selected:false,code:''}, 
				{key:'comparisionSlider', val:'comparision slider', selected:false,code:''},
...
//  console.info('...state', [...state.items])

	switch(type){

		case ActionTypes.ITEM_SELECTED_INDEX:			
		return {...state, itemSelectedIndex:payload}
		...
		case ActionTypes.PRODUCT_CHANGED:
			...
			case ActionTypes.SHOWHIDE_ALERT:
			return {
				...state, 
